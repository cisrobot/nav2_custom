...
def generate_launch_description():
    ...
    remappings=[
        ('rgb/image', '/camera/d455_camera/color/image_raw'),
        ('depth/image', '/camera/d455_camera/depth/image_rect_raw'),
        ('rgb/camera_info', '/camera/d455_camera/color/camera_info'),
        ('scan_cloud','/camera/d455_camera/depth/color/points')]
